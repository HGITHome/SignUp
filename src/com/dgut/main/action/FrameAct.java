...
public class FrameAct {
	...
	@RequestMapping("/frame/cargo_right.do")
	public String cargoRight(ModelMap model) {
		return "frame/cargo_right";
	}
	

	@RequestMapping("/frame/cargo_main.do")
	public String cargoMain(ModelMap model) {
		return "frame/cargo_main";
	}

	@RequestMapping("/frame/cargo_left.do")
	public String cargoLeft(ModelMap model) {
		return "frame/cargo_left";
	}
