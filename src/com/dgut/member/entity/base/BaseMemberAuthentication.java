...
public abstract class BaseMemberAuthentication  implements Serializable {
	...
	// constructors
	public BaseMemberAuthentication () {
		initialize();
	}
	 ...
	 */
	public BaseMemberAuthentication (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dgut.member.entity.MemberAuthentication)) return false;
		else {
			com.dgut.member.entity.MemberAuthentication authentication = (com.dgut.member.entity.MemberAuthentication) obj;
