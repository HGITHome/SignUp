...
rel=stylesheet><![endif]--><!--[if (!IE)|(gte IE 8.0)]><!--><link href="${base}/res/common/css/qbase_datauri.css" type=text/css rel=stylesheet><!--<![endif]-->
...
src="${base}/res/common/img/error.jpg" width=520>
<P style="FONT-SIZE: 24px; LINE-HEIGHT: 50px">
错误提示</P>
<P style="MARGIN-BOTTOM: 30px"><#list errors as error>
${error}<br/>
</#list></P>
<P style="FONT-SIZE: 14px; LINE-HEIGHT: 20px">您可以 <A 
  href="#" onClick="javascript :history.back(-1);">返回上一级页面</A> </DIV></DIV></DIV></SECTION><FOOTER 
